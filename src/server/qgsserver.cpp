...
bool QgsServer::init()
{
  ...
  QgsMessageLog::logMessage( "Auth DB URI: " + QgsApplication::authenticationDatabaseConnectionUri(), QStringLiteral( "Server" ), Qgis::MessageLevel::Info );
  ...
  //   creates or uses qgis-auth.db in ~/.qgis3/ or directory defined by legacy QGIS_AUTH_DB_DIR_PATH env variable
  //   or the newer QGIS_AUTH_DB_CONNECTION_URI env variable.
  ...
  QgsApplication::authManager()->setup( QgsApplication::pluginPath(), QgsApplication::authenticationDatabaseConnectionUri() );
