...
const QgsSettingsEntryBool *QgsOwsConnection::settingsWfsForceInitialGetFeature = new QgsSettingsEntryBool( QStringLiteral( "force-wfs-initial-get-feature" ), sTreeOwsConnections, false ) ;
