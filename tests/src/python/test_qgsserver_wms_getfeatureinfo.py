...
class TestQgsServerWMSGetFeatureInfo(TestQgsServerWMSTestBase):
    ...
    def testGetFeatureInfoOffset(self):
        """Test that we can get feature info from offset symbols"""

        # Lines offset (the failing test case)
        self.wms_request_compare('GetFeatureInfo',
                                 '&BBOX=52.43495994117647996,10.70279116176470957,52.44237170588235841,10.71003616176471063'
                                 + '&CRS=EPSG:4326'
                                 + '&WIDTH=391&HEIGHT=400'
                                 + r'&QUERY_LAYERS=points%20offset'
                                 + '&INFO_FORMAT=application/json'
                                 + '&I=154&J=147'
                                 + '&FEATURE_COUNT=10',
                                 'wms_getfeatureinfo_precise_points_offset',
                                 'test_project_gfi_precise.qgs')
        ...
        self.wms_request_compare('GetFeatureInfo',
                                 ...
                                 + '&I=101&J=93'
                                 + '&FEATURE_COUNT=10',
                                 'wms_getfeatureinfo_precise_points',
                                 'test_project_gfi_precise.qgs')
